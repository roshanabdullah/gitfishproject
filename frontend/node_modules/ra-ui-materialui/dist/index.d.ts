...
declare type ArrayInputProps = CommonInputProps & {
    className?: string;
    children: ReactElement;
    disabled?: boolean;
    isFetching?: boolean;
...
declare type CheckboxGroupInputProps = Omit<CommonInputProps, 'source'> & ChoicesProps & CheckboxProps & FormControlProps & {
    row?: boolean;
    source?: string;
};
...
declare const FileInput: {
    ...
    propTypes: {
        accept: PropTypes__default.Requireable<string | string[]>;
        children: PropTypes__default.Requireable<PropTypes__default.ReactElementLike>;
        className: PropTypes__default.Requireable<string>;
...
declare type FileInputProps = DropzoneOptions & CommonInputProps & {
    className?: string;
    children?: ReactNode;
...
declare type RadioButtonGroupInputProps = CommonInputProps & ChoicesProps & FormControlProps & RadioGroupProps;
...
declare type SelectArrayInputProps = ChoicesProps & Omit<SupportCreateSuggestionOptions, 'handleChange'> & Omit<CommonInputProps, 'source'> & Omit<FormControlProps, 'defaultValue' | 'onBlur' | 'onChange'> & {
    disableValue?: string;
    source?: string;
};
...
declare type SelectInputProps = Omit<CommonInputProps, 'source'> & ChoicesProps & Omit<SupportCreateSuggestionOptions, 'handleChange'> & Omit<TextFieldProps$2, 'label' | 'helperText' | 'classes'> & {
    disableValue?: string;
