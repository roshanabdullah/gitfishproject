...
var Success = function () { return (React.createElement("svg", { viewBox: "64 64 896 896", focusable: "false", "data-icon": "check-circle", width: "1em", height: "1em", fill: "#52c41a", "aria-hidden": "true" },
...
var Info = function () { return (React.createElement("svg", { viewBox: "64 64 896 896", focusable: "false", "data-icon": "info-circle", width: "1em", height: "1em", fill: "#1890ff", "aria-hidden": "true" },
...
var Warning = function () { return (React.createElement("svg", { viewBox: "64 64 896 896", focusable: "false", "data-icon": "exclamation-circle", width: "1em", height: "1em", fill: "#faad14", "aria-hidden": "true" },
...
var Error = function () { return (React.createElement("svg", { viewBox: "64 64 896 896", focusable: "false", "data-icon": "close-circle", width: "1em", height: "1em", fill: "#ff4d4f", "aria-hidden": "true" },
...
var AlertContainer = function (_a) {
    var _b = _a.floatingTime, floatingTime = _b === void 0 ? 3000 : _b, alertStyle = _a.alertStyle, containerStyle = _a.containerStyle;
    var _c = useState([]), alerts = _c[0], setAlerts = _c[1];
    var handler = useCallback(function (_a) {
        var detail = _a.detail;
        setAlerts(function (prevAlerts) { return __spreadArray(__spreadArray([], prevAlerts, true), [detail], false); });
        setTimeout(function () {
            setAlerts(function (prevAlerts) { return prevAlerts.slice(1, prevAlerts.length); });
        }, floatingTime);
    }, []);
    useEffect(function () {
    ...
    return (React.createElement("div", { id: "--react--toast-container", style: containerStyle }, alerts.map(function (_a, idx) {
        var message = _a.message, type = _a.type;
        return (React.createElement("div", { className: "--react--toast-alert", key: idx, style: alertStyle },
